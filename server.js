      ...
      "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent",
      {
        ...
        body: JSON.stringify({
          systemInstruction: {
            parts: [
              {
                text: "Ты экологический ассистент. Отвечай ТОЛЬКО на вопросы об экологии, загрязнении воздуха и воды, климате, природохранении и других экологических проблемах. На вопросы не по теме отвечай: 'Я помогаю только с вопросами по экологии. Пожалуйста, задайте вопрос о состоянии окружающей среды.'",
              },
            ],
          },
          contents: [
